...
# =================================================================
# 🔑 REPLICATE API KEY - YASHIZWEMO IMBERE HOSE 100%
# Iyi Key ifunguye umuyoboro w'ubuntu kuri Modeli isanzwe ya AI
# =================================================================
REPLICATE_API_KEY = "r8_392f6699127431114346340426d7b21efc163a1211bc99734a1d831b26551b74"
...
st.title("🎬 AECGI ULTIMATE FREE AI VIDEO ENGINE v15.0")
st.subheader("Hollywood-Grade Animation Studio (Direct Zero-Setup Node)")
st.write("Urubuga rwuzuye rwo Gukora Video z'Iminota n'Amasegonda Ukoresheje AI")

st.markdown("---")

# --- 2. SIDEBAR STATUS ---
st.sidebar.header("⚙️ AECGI Core Status")
st.sidebar.success("✅ SYSTEM STATUS: LIVE & CONNECTED")
st.sidebar.markdown("---")
st.sidebar.info(
...
st.write("Andika Prompt (Ibisobanuro mu Cyongereza), uheze ukande buto ngo AI iguhe video handles.")
